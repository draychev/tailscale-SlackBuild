This repo contains all the scripts needed to build a Tailscale 1.30.2 package for Slackware 15.0
...
1. run `make install` to build and install the package (look in the Makefile for more options)
   ...
   - and then it will `sudo installpkg /tmp/tailscale-1.30.2-amd64-1_SBo.tgz`
